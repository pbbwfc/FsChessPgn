...
The Winformsd related facilities are included in the namespace _FSChess.WinForms_. 

## Board Panel

The first component provided is a chess board panel that allows you to make legal moves. The board supports drag and drop.
